...
public class POMAutoPracticeMandatoryFieldsPage implements AutoConstant
{
	...
	public POMAutoPracticeMandatoryFieldsPage(WebDriver driver)
	{
	...
	{
		signinLink.click();
		emailAddressField.sendKeys("z2999@gmail.com");
